...
class BaseLogger{
    ...
    info(...args) {
        this.winstonInstance.info(this.context.app, this.context.traceId, this.context.ip, this.context.pid, this.context.api, this.context.ext, format(...args));
    }

    debug(...args) {
        this.winstonInstance.debug(this.context.app, this.context.traceId, this.context.ip, this.context.pid, this.context.api, this.context.ext, format(...args));
    }

    error(...args) {
        this.winstonInstance.error(this.context.app, this.context.traceId, this.context.ip, this.context.pid, this.context.api, this.context.ext, format(...args));
    }

    warn(...args) {
        this.winstonInstance.warn(this.context.app, this.context.traceId, this.context.ip, this.context.pid, this.context.api, this.context.ext, format(...args));
    }
