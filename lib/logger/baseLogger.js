...
class BaseLogger{
    ...
    constructor(options = {}) {
        ...
        if (winstonInstance === null) {
            ...
            winstonInstance = winston.getInstance();
        }
    }
