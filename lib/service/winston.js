...
class Winston {
    ...
    constructor(options) {
        ...
        */
        ...
        gloabalTransports[options.name] = [];
        gloabalTransports[options.name].push(appTransport);
        ...
        if (options.console) {
            ...
            gloabalTransports[options.name].push(consoleTransport);
        }
        ...
        if (options.needErrorFile) {
            ...
            gloabalTransports[options.name].push(errTransport);
        }
        ...
        */
        if (globalWinstonInstance[options.name] === undefined) {
            globalWinstonInstance[options.name] = createLogger({
                // transports: gloabalTransports,
                transports: gloabalTransports[options.name],
                exitOnError: false
            });
        }
    };
